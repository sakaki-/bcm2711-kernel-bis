...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 4.19.79.20191015 | [bcm2711-kernel-bis-4.19.79.20191015.tar.xz](https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/4.19.79.20191015/bcm2711-kernel-bis-4.19.79.20191015.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/4.19.79.20191015/bcm2711-kernel-bis-4.19.79.20191015.tar.xz | tar -xJf- -C /mnt/piroot/
```
...
```console
pi4 ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/4.19.79.20191015/bcm2711-kernel-bis-4.19.79.20191015.tar.xz | tar -xJf- -C /
pi4 ~ # sync
```
