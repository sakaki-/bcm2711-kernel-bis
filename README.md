...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 4.19.66.20190816 | [bcm2711-kernel-bis-4.19.66.20190816.tar.xz](https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/4.19.66.20190816/bcm2711-kernel-bis-4.19.66.20190816.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/4.19.66.20190816/bcm2711-kernel-bis-4.19.66.20190816.tar.xz | tar -xJf- -C /mnt/piroot/
```
...
```console
pi4 ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/4.19.66.20190816/bcm2711-kernel-bis-4.19.66.20190816.tar.xz | tar -xJf- -C /
pi4 ~ # sync
```
