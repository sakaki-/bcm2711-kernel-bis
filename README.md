...
This project contains a weekly autobuild of the default branch (currently, `rpi-5.4.y`) of the [official Raspberry Pi Linux source tree](https://github.com/raspberrypi/linux), for the [64-bit Raspberry Pi 4](https://www.raspberrypi.org/products/raspberry-pi-4-model-b/).
...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 5.4.65.20200915 | [bcm2711-kernel-bis-5.4.65.20200915.tar.xz](https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/5.4.65.20200915/bcm2711-kernel-bis-5.4.65.20200915.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/5.4.65.20200915/bcm2711-kernel-bis-5.4.65.20200915.tar.xz | tar -xJf- -C /mnt/piroot/
```
...
```console
pi4 ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/5.4.65.20200915/bcm2711-kernel-bis-5.4.65.20200915.tar.xz | tar -xJf- -C /
pi4 ~ # sync
```
