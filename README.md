...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 5.4.44.20200609 | [bcm2711-kernel-bis-5.4.44.20200609.tar.xz](https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/5.4.44.20200609/bcm2711-kernel-bis-5.4.44.20200609.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/5.4.44.20200609/bcm2711-kernel-bis-5.4.44.20200609.tar.xz | tar -xJf- -C /mnt/piroot/
```
...
```console
pi4 ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel-bis/releases/download/5.4.44.20200609/bcm2711-kernel-bis-5.4.44.20200609.tar.xz | tar -xJf- -C /
pi4 ~ # sync
```
